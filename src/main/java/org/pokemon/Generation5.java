...
public enum Generation5 {
    ...
    DARMANITAN_ZEN("Darmanitan", "555", "src/main/resources/pokemon/555.png", 105, Type.FIRE, Type.PSYCHIC),
    ...
    TORNADUS_THERIAN("Tornadus", "641", "src/main/resources/pokemon/641.png", 79, Type.FLYING),
    THUNDURUS_INCARNATE("Thundurus", "642", "src/main/resources/pokemon/642.png", 79, Type.ELECTRIC, Type.FLYING),
    THUNDURUS_THERIAN("Thundurus", "642", "src/main/resources/pokemon/642.png", 79, Type.ELECTRIC, Type.FLYING),
    ...
    LANDORUS_THERIAN("Landorus", "645", "src/main/resources/pokemon/645.png", 89, Type.GROUND, Type.FLYING),
    KYUREM("Kyurem", "646", "src/main/resources/pokemon/646.png", 125, Type.DRAGON, Type.ICE),
    KYUREM_BLACK("Kyurem", "646", "src/main/resources/pokemon/646.png", 125, Type.DRAGON, Type.ICE),
    KYUREM_WHITE("Kyurem", "646", "src/main/resources/pokemon/646.png", 125, Type.DRAGON, Type.ICE),
    KELDEO("Keldeo", "647", "src/main/resources/pokemon/647.png", 91, Type.WATER, Type.FIGHTING),
    KELDEO_RESOLUTE("Keldeo", "647", "src/main/resources/pokemon/647.png", 91, Type.WATER, Type.FIGHTING),
    MELOETTA_ARIA("Meloetta", "648", "src/main/resources/pokemon/648.png", 100, Type.NORMAL, Type.PSYCHIC),
    MELOETTA_PIROUETTE("Meloetta", "648", "src/main/resources/pokemon/648.png", 100, Type.NORMAL, Type.FIGHTING),
