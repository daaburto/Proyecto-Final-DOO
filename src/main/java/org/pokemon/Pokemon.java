...
public class Pokemon {
    ...
    public void cambiarEstado(int estado) {
        ...
        } else if (state.equals("deprimido")) { // Doble tipo y [x2 habitat -> pokemon] al primero
            switch (estado) {
                case 0:
        ...
        } else if (state.equals("normal")) { // Doble tipo y [x1 habitat -> pokemon] al primero
            switch (estado) {
                case 0:
                    state = "deprimido"; // x2 habitat -> pokemon
                    break;
        ...
        } else if (state.equals("feliz")) { // Doble tipo y [habitat = pokemon] al primero
            state = "feliz";
